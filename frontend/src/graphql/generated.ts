...
export type GenericMorph = About | Article | Author | Category | ComponentSharedMedia | ComponentSharedQuote | ComponentSharedRichText | ComponentSharedSeo | ComponentSharedSlider | Global | Home | I18NLocale | Product | ReviewWorkflowsWorkflow | ReviewWorkflowsWorkflowStage | UploadFile | UsersPermissionsPermission | UsersPermissionsRole | UsersPermissionsUser;
...
export type Home = {
  __typename?: 'Home';
  cover: Array<Maybe<UploadFile>>;
  cover_connection: UploadFileRelationResponseCollection;
  createdAt?: Maybe<Scalars['DateTime']['output']>;
...
export type HomeCover_ConnectionArgs = {
  filters?: InputMaybe<UploadFileFiltersInput>;
  pagination?: InputMaybe<PaginationArg>;
  sort?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
};
...
export type ProductFiltersInput = {
  ...
  inStock?: InputMaybe<BooleanFilterInput>;
  ...
  publishedAt?: InputMaybe<DateTimeFilterInput>;
  sizes?: InputMaybe<JsonFilterInput>;
  slug?: InputMaybe<StringFilterInput>;
  updatedAt?: InputMaybe<DateTimeFilterInput>;
};
...
export type GetProductsQuery = { __typename?: 'Query', products_connection?: { __typename?: 'ProductEntityResponseCollection', nodes: Array<{ __typename?: 'Product', documentId: string, name: string, slug: string, price: number, originalPrice?: number | null, discount?: number | null, image: { __typename?: 'UploadFile', url: string }, category?: { __typename?: 'Category', name: string, slug: string } | null }>, pageInfo: { __typename?: 'Pagination', page: number, pageSize: number, pageCount: number, total: number } } | null };


export const GetProductsDocument = gql`
    query GetProducts($page: Int, $limit: Int, $categorySlug: String, $featured: Boolean) {
  products_connection(
    pagination: {page: $page, pageSize: $limit}
    filters: {featured: {eq: $featured}, category: {slug: {eq: $categorySlug}}}
  ) {
    nodes {
      documentId
      name
